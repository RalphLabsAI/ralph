...
**Code:** [`KarpathianBase/karpathian`](https://github.com/KarpathianBase/karpathian/tree/v0.5.1) @ [`v0.5.1`](https://github.com/KarpathianBase/karpathian/releases/tag/v0.5.1)
...
- fp32: ~$13 per Karpathian-1 proof test
- bf16: ~$3.50 per Karpathian-1 proof test
...
|---|---|
| **wandb live monitoring** | `--wandb` flag streams loss/lr/grad_norm/throughput to [wandb.ai/karpathian-ai/karpathian](https://wandb.ai/karpathian-ai/karpathian). Public — anyone can view. |
...
| **Karpathian Live dashboard** | Streamlit dashboard with auto-refreshing loss curves, king status, noise floor stats. `streamlit run dashboard/app.py` |
...
cd karpathian && git checkout v0.5.1
...
🏷️ **This milestone:** [`v0.5.1`](https://github.com/KarpathianBase/karpathian/releases/tag/v0.5.1)
💬 **Discussions:** [github.com/orgs/KarpathianBase/discussions](https://github.com/orgs/KarpathianBase/discussions)
📊 **wandb:** [wandb.ai/karpathian-ai/karpathian](https://wandb.ai/karpathian-ai/karpathian)
